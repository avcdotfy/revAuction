 ...
 <aside class="main-sidebar">
     ...
     <section class="sidebar" style="height: auto;">
         ...
         <ul class="sidebar-menu tree" data-widget="tree" id="sidebar-menu">
             @if (PermissionHelper::hasSpecifiPermission('admin-dashboard'))
                 <li class="treeview">
                     <a href="#">
             ...
             @if (PermissionHelper::hasGroupPermission(3))
                 <li id="li_catalog" class="treeview">
                     ...
                     <ul class="treeview-menu">
                         @if (PermissionHelper::hasSpecifiPermission('category.list'))
                             <li id="catalog_category"><a href="{{ route('category.list') }}"><span
                                         class="dot-icon">.</span><span>Category</span></a>
                             </li>
                         @endif
                         @if (PermissionHelper::hasSpecifiPermission('item.list'))
             ...
             @if (PermissionHelper::hasGroupPermission(4))
                 <li id="li_vendors" class="treeview">
                     ...
                     <ul class="treeview-menu">
                         @if (PermissionHelper::hasSpecifiPermission('vendor.new_requests'))
                         ...
                         @if (PermissionHelper::hasSpecifiPermission('vendor.approved_requests'))
                         ...
                         @endif
                         @if (PermissionHelper::hasSpecifiPermission('vendor.rejected_requests'))
             ...
             @endif
             @if (PermissionHelper::hasGroupPermission(5))
                 <li id="li_events" class="treeview">
                     ...
                     <ul class="treeview-menu">
                         ...
                         @endif
                         @if (PermissionHelper::hasSpecifiPermission('event.empty'))
             ...
             @if (PermissionHelper::hasGroupPermission(6))
                 <li id="li_reports" class="treeview">
                     ...
                     <ul class="treeview-menu">
                         @if (PermissionHelper::hasSpecifiPermission('report.runningEvent'))
                         ...
                         @endif
                         @if (PermissionHelper::hasSpecifiPermission('report.closedEvent'))
                         ...
                         @endif
                         @if (PermissionHelper::hasSpecifiPermission('report.decisionTaken'))
                             <li id="reports_decision_taken_event_report">
                                 <a href="{{ route('report.decisionTaken') }}"><span
             ...
             @endif
             @if (PermissionHelper::hasGroupPermission(7))
                 <li id="li_login_trail" class="treeview">
                     ...
                     <ul class="treeview-menu">
                         @if (PermissionHelper::hasSpecifiPermission('login-trails.employeeLogin'))
                         ...
                         @endif
                         @if (PermissionHelper::hasSpecifiPermission('login-trails.vendorLogin'))
                             <li id="login_trail_vendor_login_report"><a
                                     href="{{ route('login-trails.vendorLogin') }}"><span
             ...
             @endif
             @if (PermissionHelper::hasGroupPermission(8))
                 <li id="li_notice_and_news" class="treeview">
                     ...
                     <ul class="treeview-menu">
                         @if (PermissionHelper::hasSpecifiPermission('notice.list'))
             ...
             @endif
             @if (PermissionHelper::hasGroupPermission(9))
                 <li id="li1" class="treeview">
                     ...
                     @if (PermissionHelper::hasSpecifiPermission('help.create'))
                         <ul class="treeview-menu">
             ...
             @endif
             @if (PermissionHelper::hasGroupPermission(10) ||
                 ...
                 <li id="li_settings" class="treeview">
                     ...
                     <ul class="treeview-menu">
                         ...
                         @endif
                         @if (PermissionHelper::hasGroupPermission(11))
                             <li id="li_mail_setting" class="treeview"><a href="#"><span
                                 ...
                                 @if (PermissionHelper::hasSpecifiPermission('template.email.create'))
                                     <ul class="treeview-menu">
                             ...
                             class="dot-icon">.</span><span>Configuration</span></a></li> --}}
                                         <li id="mail_setting_template"><a
                                                 href="{{ route('template.email.create') }}"><span
             ...
             <ul class="treeview-menu">
                 ...
                 <li id="sms_setting_template"><a href="{{ route('template.sms.list') }}"><span
                         ...
                         @if (PermissionHelper::hasGroupPermission(12))
