    ...
    <div class="col-sm-12" style="padding: 0px;">
        ...
        <div class="col-sm-12">
            <span id="ContentPlaceHolder1_RequiredFieldValidator1"
                style="font-size:12px;color:red;font-weight:600;display:none;">Please Enter
                Region Message</span>
            <textarea rows="2" cols="20" class="form-control" placeholder="Enter Region Message"></textarea>
        </div>
    </div>
</div>
<div class="col-sm-12" style="margin-bottom: 5px;">
...
<div class="col-sm-12" style="text-align: right;">
    <div class="col-sm-offset-2 col-sm-10">
        <input type="button" name="ctl00$ContentPlaceHolder1$btnsubmit" value="Submit" class="btn btn-sm btn-primary">
        <a href="region.html" class="btn btn-sm btn-sm btn-primary" style="color: White; margin-left: 4px">Back</a>
    </div>
</div>
