                        ...
                        <div id="ContentPlaceHolder1_div_nr" class="row">
                            <div class="col-lg-12" style="padding:13px">
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <select name="event_mode" class="form-control">
                                            ...
                                            <option selected="selected" value="101">Daily</option>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-1">
                                        <select name="Houre1" class="form-control" onchange="change_opening_time()">
                                    ...
                                    <div class="col-sm-1">
                                        <select name="ddlMinute1" class="form-control" onchange="change_opening_time()">
                                    ...
                                    <div class="col-sm-2">
                                        <input name="opening_time" type="text" value="09:00 AM" disabled="disabled"
                                            class="form-control">
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <label for="inputPassword3" class="col-sm-2 control-label">Closing Date &amp;
                                        Time</label>
                                    <div class="col-sm-5">
                                        <input name="closing_date" type="date" value="2023-07-04"
                                            class="form-control" placeholder="Enter Closing Date">
                                    </div>
                                    <div class="col-sm-1">
                                        <select name="ddlHoure2" class="form-control" onchange="change_closing_time()">
                                            <option value="01">01</option>
                                            <option value="02">02</option>
                                            <option value="03">03</option>
                                            <option value="04">04</option>
                                    ...
                                    <div class="col-sm-1">
                                        <select name="ddlMinute2" class="form-control" onchange="change_closing_time()">
                                            <option selected="selected" value="00">00</option>
                                            <option value="01">01</option>
                                            <option value="02">02</option>
                                            <option value="03">03</option>
                                    ...
                                    <div class="col-sm-1">
                                        <select name="ddlAMPM2" class="form-control" onchange="change_closing_time()">
                                    ...
                                    <div class="col-sm-2">
                                        <input name="closing_time" type="text" value="06:00 PM" disabled="disabled"
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <select name="product_range_list" class="form-control">
                                            ...
                                            <option value="106">Aluminium Coils</option>
                                            <option value="105">Aluminium Pipe</option>
                                ...
                                <div class="col-sm-12">
                                    <div id="dtable_wrapper" class="dataTables_wrapper no-footer">
                                        <div class="dataTables_length col-lg-9" id="dtable_length"
                                            ...
                                            <label>Show <select name="dtable_length" aria-controls="dtable"
                                                    class="">
                                                    <option value="10">10</option>
                                                    <option value="25">25</option>
                                                    <option value="50">50</option>
                                        ...
                                        <table id="dtable"
                                            ...
                                            <tbody>
                                                ...
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td>NAAS Steel Works Ltd</td>

                                                    <td><span id="ContentPlaceHolder1_lvNvR_lblusername_0">bidder19</span>
                                                    </td>
                                                    <td><span id="ContentPlaceHolder1_lvNvR_lblmobile_0">9876543210</span>
                                                    </td>
                                                    <td><span
                                                            id="ContentPlaceHolder1_lvNvR_lblemail_0">bidder19@gmail.com</span>
                                                    </td>
                                        ...
                                        <div class="col-lg-12 " style="padding-left: 0px; padding-right: 0px">
                                            <p class="col-lg-6"
                                                style="text-align: left;padding-left: 8px; line-height: 30px">Showing 1 to
                                                4 of 4 entries</p>
                                        ...
                                        <table id="dtable"
                                            ...
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting_disabled" rowspan="1" colspan="1"
                                                        style="width: 44.7292px;">Select</th>
                                                    <th class="sorting_disabled" rowspan="1" colspan="1"
                                                        style="width: 170.583px;">Item Code & Description</th>

                                                    <th class="sorting_disabled" rowspan="1" colspan="1"
                                                        style="width: 76.0521px;">UoM</th>
                                                    <th class="sorting_disabled" rowspan="1" colspan="1"
                                                        style="width: 93.6562px;">Item Region, Price & Unit Details</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td><span>Pipe-8011/DPE(UY)/KKL-1835 (ALPIM01)</span></td>
                                                    <td><span>Ton</span></td>
                                                    <td>
                                                        <div class="col-sm-12"
                                                            style="border: 1px solid #d2d6de; border-radius: 6px; padding-top:5px;padding-bottom:5px;">
                                                            <span class="label label-success"
                                                                style="white-space: unset;">200 Ton | 1 Unit = 1 Ton</span>
                                                            <div>
                                                                <span
                                                                    id="ContentPlaceHolder1_lvIl_lvIRP_0_lbl_region_name_0">PAN
                                                                    India</span>
                                                                :
                                                                <span
                                                                    id="ContentPlaceHolder1_lvIl_lvIRP_0_lbl_item_region_price_0"
                                                                    title="151">5000000.00</span>
                                                            </div>
                                                        </div>
                                                    </td>
                            ...
                            <div class="col-sm-12" style="margin-bottom: 5px;">
                                ...
                                <div class="col-sm-12" style="margin-bottom: 5px;">
                                    ...
                                    <label for="inputPassword3" class="col-sm-12 control-label"
                                        style="padding: 0px">Subject Line <span
                                            style="color: red; font-size: 13px; ">*</span></label>
                                    <div class="col-sm-12" style=" padding: 0px">
                                        <input type="text" class="form-control"
                                            placeholder="Preparation of Event for Aluminium Pipe" name="">
