...
@section('main_section')
    ...
    <section class="content-header">
        <h3 style="margin-top: 10px; margin-bottom: 20px">Home | Events | Participated Events List </h3>
                                    ...
                                    <table class="table table-bordered table-striped dataTable no-footer" role="grid"
                                        ...
                                        <tbody>
                                            ...
                                            <tr role="row" class="odd">
                                                <td>1</td>
                                                <td><a href="{{ route('vendor.posted-event-info') }}">ST020907202357</a>
                                                </td>
                                                <td>Event for [Steel] : Opening Date &amp; Time - Sun 09-Jul-2023 08:18 PM
                                                    and Closing Date &amp; Time - Sun 09-Jul-2023 09:01 PM (Daily)</td>
                                                <td><a href="{{ route('vendor.participated-event-item-list') }}"
                                                        target="_blank">Participated Items List</a></td>
                                            </tr>

                                            <tr role="row" class="even">
                                                <td>2</td>
                                                <td><a href="{{ route('vendor.posted-event-info') }}">ST020806202344</a>
                                                </td>
