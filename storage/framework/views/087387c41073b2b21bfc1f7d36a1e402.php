...
<?php $__env->startSection('login-form'); ?>
    <form method="post" action="<?php echo e(route('admin-login')); ?>" onsubmit="javascript:return WebForm_OnSubmit();"
        ...
        <div class="login-box" style="border-radius:6px;background-color:#fff;border:1px solid #d2d6de;">
            <div class="login-logo" style="margin-bottom:0px;padding-top:20px;">
                <a href="login.html"><img src="<?php echo e(asset('images/logo.png')); ?>" style="height:76px;" /></a>
            </div>
            <div class="login-logo" style="margin-bottom:0px;font-size:28px;padding-top:20px;">
                <a href="#" style="border-bottom:1px solid #000"><b id="company_name"
                        style="color:#000;"><b><?php echo e(env('APP_NAME')); ?></b></a>
            </div>
...
<?php echo $__env->make('public.layout.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\revAuction\resources\views/public/pages/login/admin-login.blade.php ENDPATH**/ ?>