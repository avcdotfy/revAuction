  <div class="col-sm-12" style="margin-bottom: 5px;">
      <div class="col-sm-6" style="padding: 0px;">
          ...
          <div class="col-sm-12">
              <select name="vendor_type" id="vendor_type" class="form-control" required>
                  ...
                  <?php $__currentLoopData = COMPANY_TYPE; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <option value="<?php echo e($c_type); ?>"
                          <?php echo e($v ? ($c_type == $v->vendor_type ? 'selected' : '') : ''); ?>>
                          <?php echo e($c_type); ?></option>
      ...
      <div class="col-sm-6" style="padding: 0px;">
          ...
          <div class="col-sm-12">
              ...
              <input name="company_name" value="<?php echo e($v ? $v->company_name : old('company_name')); ?>" type="text"
  ...
  <div class="col-sm-12" style="margin-bottom: 5px;">
      <div class="col-sm-6" style="padding: 0px;">
          <label for="contact_person" class="col-sm-12 control-label">Contact Person <span
                  style="color: red; font-size: 13px;">*</span></label>
          <div class="col-sm-12">
              <input name="contact_person" value="<?php echo e($v ? $v->contact_person : old('contact_person')); ?>" type="text"
      ...
      <div class="col-sm-6" style="padding: 0px;">
          <label for="gst_number" class="col-sm-12 control-label">GSTIN <span
                  style="color: red; font-size: 13px;">*</span></label>
          <div class="col-sm-12">
              <input name="GSTIN" type="text" value="<?php echo e($v ? $v->GSTIN : old('GSTIN')); ?>" id="gst_number"
  ...
  <div class="col-sm-12" style="margin-bottom: 5px">
      <div class="col-sm-6" style="padding: 0px;">
          ...
          <div class="col-sm-12">
              ...
              <input name="pan_tan" type="text" value="<?php echo e($v ? $v->pan_tan : old('pan_tan')); ?>" id="pan_number"
      ...
      <div class="col-sm-6" style="padding: 0px;">
          <label for="inputPassword3" class="col-sm-12 control-label">Establishment
              Year</label>
          <div class="col-sm-12">
              <input name="establish_year" type="text" value="<?php echo e($v ? $v->establish_year : old('establish_year')); ?>"
          ...
          <div class="col-sm-6" style="padding: 0px;">
              ...
              <div class="col-sm-12">
                  <input name="mse_registration_number"
                      value="<?php echo e($v ? $v->mse_registration_number : old('mse_registration_number')); ?>" type="text"
          ...
          <div class="col-sm-6" style="padding: 0px;">
              ...
              <div class="col-sm-12">
                  ...
                  <span id="spn_check_username" style="display: none; color: red; font-size: 12px;">Login ID /
                      Username
                      Already Exists.</span>
                  <input name="username" type="text" id="username" value="<?php echo e(old('username')); ?>"
  ...
  <div class="col-sm-12" style="margin-bottom: 5px;">
      <div class="col-sm-6" style="padding: 0px;">
          <label for="inputPassword3" class="col-sm-12 control-label">Email ID <span
                  style="color: red; font-size: 13px;">*</span></label>
          <div class="col-sm-12">
              <input name="email" type="text" value="<?php echo e($v ? $v->user->email : old('email')); ?>" id="email"
      ...
      <div class="col-sm-6" style="padding: 0px;">
          ...
          <div class="col-sm-12">
              ...
              <input name="phone" type="text" value="<?php echo e($v ? $v->user->phone : old('phone')); ?>" id="phone"
  ...
  <div class="col-sm-12" style="margin-bottom:5px;">
      <div class="col-sm-6" style="padding: 0px;">
          <label for="inputPassword3" class="col-sm-12 control-label">Landline
              Number</label>
          <div class="col-sm-12">
              <input name="landline" type="text" value="<?php echo e($v ? $v->user->landline : old('landline')); ?>"
      ...
      <div class="col-sm-6" style="padding: 0px;">
          ...
          <div class="col-sm-12">
              <input name="fax_number" type="text" value="<?php echo e($v ? $v->user->fax_number : old('fax_number')); ?>"
      ...
      <div class="col-sm-12" style="padding: 0px;">
          ...
          <div class="col-sm-12">
              <input name="registered_address"
                  value="<?php echo e($v ? $v->user->registered_address : old('registered_address')); ?>" type="text"
  ...
  <?php if(!Auth::user()): ?>
      ...
      <div class="col-sm-12" style="margin-bottom: 5px;">
          <div class="col-sm-6" style="padding: 0px;">
              ...
              <div class="col-sm-12">
                  <input name="city" type="text" id="city" value="<?php echo e(old('city')); ?>"
              ...
              <select name="preference_category[]" class="form-control select2" multiple id="category_id" required>
                  <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <option value="<?php echo e($category->id); ?>"
                          <?php if($v): ?> <?php $__currentLoopData = $v->categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php echo e($cat->id == $category->id ? 'selected' : ''); ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> <?php endif; ?>>
              ...
              <select class="form-control select2" multiple name="preference_region[]" id="region_id" required>
                  <?php $__currentLoopData = $regions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <option value="<?php echo e($reg->id); ?>"
                          <?php if($v): ?> <?php $__currentLoopData = $v->regions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $region): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php echo e($region->id == $reg->id ? 'selected' : ''); ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> <?php endif; ?>>
                          <?php echo e($reg->name); ?></option>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </select>
          </div>
      </div>
      ...
      <div class="col-sm-6" style="padding: 0px;">
          ...
          <div class="col-sm-12">
              ...
              <input type="file" multiple="multiple" name="docs[]" id="fu_documents" class="form-control"
                  accept=".pdf,.doc,.docx" style="padding:4px 6px;" <?php echo e(!Auth::user() ? 'required' : ''); ?>>
          </div>
      </div>
  </div>
  ...
  <?php endif; ?>
<?php /**PATH C:\xampp\htdocs\resources\views/public/pages/register/form.blade.php ENDPATH**/ ?>