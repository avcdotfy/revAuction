            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        <!-- Menu Footer-->
                        <?php if(PermissionHelper::hasSpecifiPermission('change.password')): ?>
                            <li>
                        ...
                        <?php if(PermissionHelper::hasSpecifiPermission('logout')): ?>
                            <li>
...
<?php /**PATH C:\xampp\htdocs\resources\views/admin/partials/top-nav.blade.php ENDPATH**/ ?>