                                        ...
                                        <?php $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr role="row" class="odd">
                                                ...
                                                <td><a id="ContentPlaceHolder1_lvCe_btn_l1_generate_report_2"
                                                        ...
                                                        Report</a></td>
                                                <td><a href="<?php echo e(route('decision.take', $event->id)); ?>" target="_blank">Take
                                                        Decision</a></td>
...
<?php echo $__env->make('admin.layout.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\revAuction\resources\views/admin/pages/event/closed.blade.php ENDPATH**/ ?>