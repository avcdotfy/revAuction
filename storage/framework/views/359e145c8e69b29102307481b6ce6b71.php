    ...
    <form method="post" action="<?php echo e(route('admin-login')); ?>">
        ...
        <div class="login-box" style="border-radius:6px;background-color:#fff;border:1px solid #d2d6de;">
            <div class="login-logo" style="margin-bottom:0px;padding-top:20px;">
                <a href="login.html"><img src="<?php echo e(asset('media/logo/logo.png')); ?>" style="height:76px;" /></a>
            </div>
...
<?php echo $__env->make('public.layout.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\revAuctionLatest\resources\views/public/pages/login/admin-login.blade.php ENDPATH**/ ?>