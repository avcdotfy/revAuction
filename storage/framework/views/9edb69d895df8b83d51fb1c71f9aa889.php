     ...
     <div class="col-sm-12">
         ...
         <div class="col-sm-10">
             <select name="eventmode_id" class="form-control" required id="eventMode">
                 ...
                 <?php $__currentLoopData = $eventModes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $em): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                     <option value="<?php echo e($em->id); ?>"><?php echo e($em->mode); ?></option>
 ...
 <div class="col-sm-12" style="margin-bottom: 5px;">
     <div class="col-sm-12" style="padding: 5px;">
         ...
         <div class="col-sm-12" style="margin-bottom: 5px;">
             <textarea id="default" name="terms_condition" style="height: 80px"><?php echo e(TERMS_AND_CONDITIONS); ?></textarea>
         </div>
     </div>
     <div class="col-sm-12" style="margin-bottom: 5px;">
     ...
     <div class="col-sm-12" style="padding: 5px;">
         ...
         <div class="col-sm-12" style="margin-bottom: 5px;">
             <textarea id="default" class="default" style="height: 80px" name="email_format"><?php echo e(EMAIL_FORMAT); ?></textarea>
 ...
 <?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\resources\views/admin/pages/event/form.blade.php ENDPATH**/ ?>