...
<header class="main-header">
    ...
    <!-- Logo -->
    <a href="<?php echo e(route('vendor.dashboard')); ?>" class="logo">
        <!-- mini logo for sidebar mini 50x50 pixels -->
        <?php if(Auth::user()->vendor->logo): ?>
            <img src="<?php echo e(Storage::url('company_logo/' . Auth::user()->vendor->logo)); ?>" alt="" width="80"
                height="80" srcset="">
        <?php else: ?>
            <span class="logo-mini"><?php echo e(env('APP_NAME')); ?></span>
        <?php endif; ?>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><?php echo e(env('APP_NAME')); ?></span>
    </a>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"
                        ...
                        <img src="<?php echo e(asset('images/user.jpg')); ?>" style="width: 30px">
                    </a>
                    <ul class="dropdown-menu">
                        <!-- Menu Footer-->
                        <li>
                            <a href="<?php echo e(route('change.password')); ?>" style="padding:7px 8px;"><i class="bx bx-lock"
...
<?php /**PATH C:\xampp\htdocs\resources\views/vendor/partials/top-nav.blade.php ENDPATH**/ ?>