         ...
         <ul class="sidebar-menu tree" data-widget="tree" id="sidebar-menu">
             ...
             <li id="li_events" class="treeview">
                 ...
                 <ul class="treeview-menu">
                     ...
                     <li id="events_upcoming_events"><a href="<?php echo e(route('vendor.upcoming-events')); ?>"><span
                                 class="dot-icon">.</span><span>Upcoming Events</span></a></li>
                     <li id="events_upcoming_events"><a href="<?php echo e(route('vendor.running-events')); ?>"><span
                                 class="dot-icon">.</span><span>Running Events</span></a></li>
                     <li id="events_running_events"><a href="<?php echo e(route('vendor.participated-events')); ?>"><span
                                 class="dot-icon">.</span><span>Participated Events</span></a></li>
                     <li id="events_closed_events"><a href="<?php echo e(route('vendor.participated-events-status')); ?>"><span
             ...
             <li id="li_reports" class="treeview">
                 ...
                 <ul class="treeview-menu">
                     <li id="events_running_events"><a href="<?php echo e(route('vendor.participated-event-reports')); ?>"><span
                                 class="dot-icon">.</span><span>Participated Events</span></a></li>
                     <li id="events_closed_events"><a
                             href="<?php echo e(route('vendor.participated-event-status-reports')); ?>"><span
                                 class="dot-icon">.</span><span>Participated Events Status</span></a></li>
                 </ul>
             </li>

             <li id="li_notice_and_news" class="treeview">
                 <a href="<?php echo e(route('vendor.notice-news')); ?>">
                 ...
                 <ul class="treeview-menu">
                     <li id="notice_and_news_notice"><a href="<?php echo e(route('vendor.notice-news')); ?>"><span
             ...
             <li id="li1" class="treeview">
                 ...
                 <ul class="treeview-menu">
                     <li id="Li2"><a href="<?php echo e(route('vendor.help-support')); ?>"><span
...
<?php /**PATH C:\xampp\htdocs\revAuction\resources\views/vendor/partials/side-nav.blade.php ENDPATH**/ ?>