...
<?php $__env->startSection('main_section'); ?>
    ...
    <section class="content">
        ...
        <div class="row">
                        ...
                        <div id="ContentPlaceHolder1_div_list" class="row">
                            <div class="col-sm-12">
                                <table id="dtable" class="table table-bordered table-striped dataTable no-footer"
                                    ...
                                    <tbody>
                                        <form action="" id="#form">
                                            <?php $__currentLoopData = $new_reqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $req): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <?php echo $__env->make('admin.partials.new-request-remark-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <!-- /.row -->
    </section>
    <!-- /.content -->
...
<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        function rejectReq(ids) {
            ...
            $.ajax({
                type: "get",
                url: "<?php echo e(route('request.reject')); ?>",
                data: {
                    "ids": setIds(),
                    "msg": msg
                },
...
<?php echo $__env->make('admin.layout.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\revAuction\resources\views/admin/pages/vendor/new-request.blade.php ENDPATH**/ ?>