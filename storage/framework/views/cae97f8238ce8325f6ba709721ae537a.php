                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"
                        ...
                        <span id="spn_username" class="hidden-xs"
                            style="text-transform: capitalize; padding-top: 20px">Welcome Hi, <?php echo e(Auth()->user()->username); ?> &nbsp;</span>
...
<?php /**PATH C:\xampp\htdocs\revAuction\resources\views/admin/partials/top-nav.blade.php ENDPATH**/ ?>