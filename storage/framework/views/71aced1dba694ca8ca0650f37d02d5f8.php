...
<body class="sidebar-mini skin-blue" style="background: #222d32;">
    ...
    <?php echo $__env->make('vendor.partials.logout-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

    <?php echo $__env->make('vendor.partials.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

    <?php echo $__env->make('vendor.partials.scripts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script>
        $(document).ready(function() {
            Echo.private('eventCreated.' + <?php echo e(Auth::user()->vendor->id); ?>).listen('EventCreated',
                function(data) {
                    console.log(data);
...
<?php /**PATH C:\xampp\htdocs\resources\views/vendor/layout/base.blade.php ENDPATH**/ ?>