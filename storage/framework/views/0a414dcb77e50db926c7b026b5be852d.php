                                ...
                                <div class="info-box bg-yellow">
                                    ...
                                    <div class="info-box-content">
                                        ...
                                        <span id="ContentPlaceHolder1_lbl_UeC"
                                            class="info-box-number"><?php echo e($upcomingEvents); ?></span>
                                    </div>
                                    <!-- /.info-box-content -->
                                </div>
                            </div>
                                ...
                                <div class="info-box bg-blue">
                                    ...
                                    <div class="info-box-content">
                                        ...
                                        <span id="ContentPlaceHolder1_lbl_ReC"
                                            class="info-box-number"><?php echo e($runningEvents); ?></span>
                                    </div>
                                    <!-- /.info-box-content -->
                                </div>
                            </div>
                                ...
                                <div class="info-box bg-navy">
                                    ...
                                    <div class="info-box-content">
                                        ...
                                        <span id="ContentPlaceHolder1_lbl_CeC"
                                            class="info-box-number"><?php echo e($closedEvents); ?></span>
                                    </div>
                                    <!-- /.info-box-content -->
                                </div>
                            </div>
...
<?php echo $__env->make('admin.layout.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\revAuction\resources\views/admin/pages/dashboard/dashboard.blade.php ENDPATH**/ ?>