...
<body class="hold-transition login-page">
    ...
    <div class="login-box" style="border-radius:6px;background-color:#fff;border:1px solid #d2d6de;">
        <div class="login-logo" style="margin-bottom:0px;padding-top:20px;">
            <a href="login.html"><img src="<?php echo e(asset('images/logo.png')); ?>" style="height:70px;" /></a>
        </div>
        ...
        <form action="<?php echo e(route('vendor.login')); ?>" method="post">
            <?php echo csrf_field(); ?>
            <?php echo $__env->make('public.partials.login-form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </form>
...
<?php /**PATH C:\xampp\htdocs\revAuction\resources\views/public/pages/login/vendor-login.blade.php ENDPATH**/ ?>